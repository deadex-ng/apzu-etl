CREATE PROCEDURE `create_last_eid_outcome`(IN _endDate DATE)
BEGIN
    ...
    CREATE TEMPORARY TABLE last_eid_facility_outcome(
	 ...
	 INSERT INTO last_eid_facility_outcome (index_desc, pat, state,program,program_state_id, start_date,end_date,location)
