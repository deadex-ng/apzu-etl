...
insert into moh_cohort_disaggregated(age_group, gender,tx_new,tx_curr,tx_curr_ipt,tx_curr_screened_tb,0A,2A,4A,5A,6A,7A,8A,9A,10A,11A,12A,13A,14A,15A,16A,17A,0P,2P,4PP,4PA,9P,9PP,9PA,11P,11PP,11PA,12PP,12PA,14PP,14PA,15PP,15PA,16P,17PP,17PA,non_standard)
SELECT	
