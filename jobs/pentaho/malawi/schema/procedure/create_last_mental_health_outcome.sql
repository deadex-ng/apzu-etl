CREATE PROCEDURE `create_last_mental_health_outcome`(IN _endDate DATE)
BEGIN
	DROP TEMPORARY TABLE IF EXISTS last_mental_health_outcome;

    CREATE TEMPORARY TABLE last_mental_health_outcome(
	 ...
	 INSERT INTO last_mental_health_outcome (index_desc, pat, state,program,program_state_id, start_date,end_date,location)
