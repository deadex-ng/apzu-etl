CREATE PROCEDURE `create_last_mental_health_outcome_at_facility`(IN _endDate DATE, IN _location VARCHAR(255))
BEGIN
DROP TEMPORARY TABLE IF EXISTS last_mental_facility_outcome;

    CREATE TEMPORARY TABLE last_mental_facility_outcome(
...
INSERT INTO last_mental_facility_outcome (index_desc, pat,identifier, state,program,program_state_id, start_date,end_date,location)
